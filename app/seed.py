...
SPACES = [
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4372, lng=-70.6406, price=12000, capacity=8, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4560, lng=-70.5970, price=9000, capacity=6, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.4128, lng=-70.5781, price=28000, capacity=12, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.3987, lng=-70.5873, price=22000, capacity=10, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4622, lng=-70.6441, price=8000, capacity=5, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.3730, lng=-70.6260, price=35000, capacity=16, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.4258, lng=-70.6103, price=18000, capacity=20, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.5120, lng=-70.5870, price=14000, capacity=24, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.5120, lng=-70.7600, price=12000, capacity=18, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.4512, lng=-70.6601, price=10000, capacity=4, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.4380, lng=-70.7750, price=9500, capacity=22, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.4179, lng=-70.6063, price=25000, capacity=14, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4398, lng=-70.6516, price=15000, capacity=25, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.4175, lng=-70.5989, price=32000, capacity=20, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4530, lng=-70.6320, price=11000, capacity=18, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4556, lng=-70.6810, price=8500, capacity=10, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4330, lng=-70.6350, price=45000, capacity=120, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.3950, lng=-70.5940, price=75000, capacity=200, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.3790, lng=-70.5230, price=55000, capacity=150, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.4440, lng=-70.6680, price=38000, capacity=100, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4150, lng=-70.6530, price=22000, capacity=10, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4640, lng=-70.5850, price=35000, capacity=8, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.4080, lng=-70.5640, price=45000, capacity=12, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.4310, lng=-70.6148, price=15000, capacity=15, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.3980, lng=-70.6010, price=38000, capacity=60, rating=0.0, reviews=0,
    ...
    dict(provider_idx=0,
         ...
         lat=-33.4305, lng=-70.6370, price=28000, capacity=40, rating=0.0, reviews=0,
    ...
    dict(provider_idx=1,
         ...
         lat=-33.5050, lng=-70.7650, price=18000, capacity=80, rating=0.0, reviews=0,
    ...
    dict(provider_idx=2,
         ...
         lat=-33.4168, lng=-70.6050, price=55000, capacity=50, rating=0.0, reviews=0,
...
VENUES_REALES = [
    dict(
        ...
        price=80000, capacity=1000, rating=0.0, reviews=0,
        ...
        sub_spaces=[
            dict(provider_idx=0, name="GAM - Sala A1", type=SpaceType.SALA,
                 ...
                 lat=-33.4442, lng=-70.6535, price=45000, capacity=220, rating=0.0, reviews=0,
            ...
            dict(provider_idx=0, name="GAM - Sala A2", type=SpaceType.SALA,
                 address="Av. Libertador Bernardo O'Higgins 227", city="Santiago",
                 lat=-33.4442, lng=-70.6535, price=35000, capacity=150, rating=0.0, reviews=0,
            ...
            dict(provider_idx=0, name="GAM - Sala Isidora Zegers", type=SpaceType.SALA,
                 address="Av. Libertador Bernardo O'Higgins 227", city="Santiago",
                 lat=-33.4442, lng=-70.6535, price=28000, capacity=80, rating=0.0, reviews=0,
            ...
            dict(provider_idx=0, name="GAM - Terraza", type=SpaceType.TERRAZA,
                 address="Av. Libertador Bernardo O'Higgins 227", city="Santiago",
                 lat=-33.4442, lng=-70.6535, price=55000, capacity=300, rating=0.0, reviews=0,
    ...
    dict(
        ...
        price=60000, capacity=300, rating=0.0, reviews=0,
        ...
        sub_spaces=[
            dict(provider_idx=2, name="Casona San Isidro - Salón Principal", type=SpaceType.SALON,
                 ...
                 lat=-33.4510, lng=-70.6480, price=55000, capacity=180, rating=0.0, reviews=0,
            ...
            dict(provider_idx=2, name="Casona San Isidro - Patio Central", type=SpaceType.TERRAZA,
                 address="San Isidro 63", city="Santiago",
                 lat=-33.4510, lng=-70.6480, price=40000, capacity=120, rating=0.0, reviews=0,
            ...
            dict(provider_idx=2, name="Casona San Isidro - Sala de Reuniones", type=SpaceType.SALA,
                 address="San Isidro 63", city="Santiago",
                 lat=-33.4510, lng=-70.6480, price=18000, capacity=20, rating=0.0, reviews=0,
    ...
    dict(
        ...
        price=70000, capacity=500, rating=0.0, reviews=0,
        ...
        sub_spaces=[
            dict(provider_idx=1, name="Matucana 100 - Teatro Principal", type=SpaceType.SALA,
                 ...
                 lat=-33.4435, lng=-70.6680, price=65000, capacity=300, rating=0.0, reviews=0,
            ...
            dict(provider_idx=1, name="Matucana 100 - Galpón", type=SpaceType.SALON,
                 address="Matucana 100", city="Santiago",
                 lat=-33.4435, lng=-70.6680, price=50000, capacity=500, rating=0.0, reviews=0,
            ...
            dict(provider_idx=1, name="Matucana 100 - Sala Experimental", type=SpaceType.SALA,
                 address="Matucana 100", city="Santiago",
                 lat=-33.4435, lng=-70.6680, price=22000, capacity=60, rating=0.0, reviews=0,
    ...
    dict(
        ...
        price=90000, capacity=400, rating=0.0, reviews=0,
        ...
        sub_spaces=[
            dict(provider_idx=2, name="Los Leones - Salón Cordillera", type=SpaceType.SALON,
                 ...
                 lat=-33.4160, lng=-70.5900, price=85000, capacity=300, rating=0.0, reviews=0,
            ...
            dict(provider_idx=2, name="Los Leones - Sala Directorio", type=SpaceType.SALA,
                 address="Av. Presidente Riesco 3700", city="Santiago",
                 lat=-33.4160, lng=-70.5900, price=40000, capacity=24, rating=0.0, reviews=0,
            ...
            dict(provider_idx=2, name="Los Leones - Terraza Jardines", type=SpaceType.TERRAZA,
                 address="Av. Presidente Riesco 3700", city="Santiago",
                 lat=-33.4160, lng=-70.5900, price=65000, capacity=200, rating=0.0, reviews=0,
    ...
    dict(
        ...
        price=25000, capacity=80, rating=0.0, reviews=0,
        ...
        sub_spaces=[
            dict(provider_idx=0, name="Fábrica de Arte - Estudio Fotográfico", type=SpaceType.ESTUDIO,
                 ...
                 lat=-33.4420, lng=-70.6650, price=22000, capacity=10, rating=0.0, reviews=0,
            ...
            dict(provider_idx=0, name="Fábrica de Arte - Sala de Ensayo Musical", type=SpaceType.ESTUDIO,
                 address="Compañía de Jesús 1250", city="Santiago",
                 lat=-33.4420, lng=-70.6650, price=15000, capacity=8, rating=0.0, reviews=0,
            ...
            dict(provider_idx=0, name="Fábrica de Arte - Taller de Cerámica", type=SpaceType.ESTUDIO,
                 address="Compañía de Jesús 1250", city="Santiago",
                 lat=-33.4420, lng=-70.6650, price=12000, capacity=12, rating=0.0, reviews=0,
